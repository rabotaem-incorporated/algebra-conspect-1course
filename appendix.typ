...
#locate(loc => {
    ...
    Обращаю внимание, что границы билетов расставлены субъективным образом, и используется предворительная (!) версия списка билетов. Если хотите исправить, просто сделайте PR. #text(weight: "bold")[Точные границы того, что входит в билет, а что нет, нужно узнать на консультации.] А, она уже была. Ну, удачи!
